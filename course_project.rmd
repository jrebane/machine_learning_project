...
Applying our model, `modFit`, to our testing partition, `sub_testing`, we see an Out-of Sample accuracy of `r con_matrix$overall['Accuracy']`, which implies an out-of-sample error rate of `r 1 - con_matrix$overall['Accuracy']`.
